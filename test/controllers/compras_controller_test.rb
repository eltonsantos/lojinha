...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { orderable_id: @compra.orderable_id, orderable_type: @compra.orderable_type, usuario: @compra.usuario } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { orderable_id: @compra.orderable_id, orderable_type: @compra.orderable_type, usuario: @compra.usuario } }
